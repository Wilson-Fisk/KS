...
from kingpinscrapers.windows.base import BaseDialog
...
class TextViewerXML(BaseDialog):
	...
	def set_properties(self):
		self.setProperty('kingpinscrapers.text', self.text)
		self.setProperty('kingpinscrapers.heading', self.heading)